package com.example.estebancastro.asignacionno2.Home;
...
import com.example.estebancastro.asignacionno2.Factorial.FactorialLayoutFragment;
import com.example.estebancastro.asignacionno2.Fibonacci.FibonacciLayoutFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (navigationDrawerSelectedItem){
            case R.id.nav_factorial_layout:
                showFactorialLayoutFragment();
                iCodFragment = 1;
                break;
            case R.id.nav_fibonacci_layout:
                showFibonacciLayoutFragment();
                iCodFragment = 2;
                break;
